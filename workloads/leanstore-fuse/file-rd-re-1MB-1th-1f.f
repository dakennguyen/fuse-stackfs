...
#system "sync"
#system "umount /mnt/leanfs/"
#Change accordingly for HDD(sdb) and SSD(sdd)
# system "mount -t ext4 /dev/sdd /mnt/leanfs"
#warm up the cache (RAM)
system "sync"
system "echo 3 > /proc/sys/vm/drop_caches"
system "dd if=/mnt/leanfs/bigfileset/00000001/00000001 of=/dev/null bs=4096 count=1048576 &> /dev/null"
